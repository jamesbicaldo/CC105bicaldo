...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>clini Management - Login</title>
      ...
      <div id="login-form" class="card m-auto p-2">
        <div class="card-body">
          <form name="login-form" class="login-form" action="home.php" method="post" onsubmit="return validateCredentials();">
            <div class="logo">
        			<img src="" class="tooth"/>
        			<h1 class="logo-caption">Gusi - Famaran Dental Clinic</h1>
        		</div> <!-- logo class -->
            ...
            <div class="form-group">
              <button class="btn btn-default btn-block btn-custom">Gusi - Famaran Dental Clinic</button>
            </div>
          </form><!-- form close -->
